  ...
  return (
    <>
      {theme && (
        <Element name="desc">
          <S.Layout>
            <h3 className="cafe">{theme.cafe}</h3>
            <h2 className="room">{theme.room}</h2>
            <div className="description">
              {theme.description.split(".").map((line) => {
                return (
            ...
            <S.Grid>
              ...
              <GridItem key="장치비율" name="장치비율" data={theme.theme} />
              ...
              <GridItem key="추천인원" name="추천인원" data={theme.recommend} />
            </S.Grid>
          </S.Layout>
        </Element>
      )}
